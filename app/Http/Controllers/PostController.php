...
class PostController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile(featured_image)) {
            ...
            // Add the new photo
            $image = $request->file('featured_image');
            $filename = time() . '.' . $image->getClientOirginalExtension();
            $location = public_path('images/' . $filename);
            Image::make($image)->resize(1900, 600)->save($location);
        ...
        // redirect with flash data to the show requests posts.show
        return redirect()->route('posts.show', $post->id);
    }
    ...
    public function destroy($id)
    {
        ...
        Session::flash('success', 'This post was successfuly deleted!');
